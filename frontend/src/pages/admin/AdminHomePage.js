...
const AdminHomePage = () => {
    ...
    const { studentsList, loading: loadingStudents } = useSelector((state) => state.student);
    const { sclassesList, loading: loadingClasses } = useSelector((state) => state.sclass);
    const { teachersList, loading: loadingTeachers } = useSelector((state) => state.teacher);
    ...
    if (loadingStudents || loadingClasses || loadingTeachers) {
