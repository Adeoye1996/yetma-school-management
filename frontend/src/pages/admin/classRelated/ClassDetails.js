...
const ClassDetails = () => {
    ...
    const SubjectsButtonHaver = ({ row }) => (
        <>
            <IconButton onClick={() => deleteHandler(row.id, "Subject")} aria-label={`Delete subject ${row.name}`}>
                <DeleteIcon color="error" />
            </IconButton>
            <BlueButton
                variant="contained"
                onClick={() => navigate(`/Admin/class/subject/${classID}/${row.id}`)}
                aria-label={`View details of subject ${row.name}`}
            >
                View
            </BlueButton>
        </>
    ...
    const StudentsButtonHaver = ({ row }) => (
        <>
            <IconButton onClick={() => deleteHandler(row.id, "Student")} aria-label={`Delete student ${row.name}`}>
                <PersonRemoveIcon color="error" />
            </IconButton>
            <BlueButton
                variant="contained"
                onClick={() => navigate("/Admin/students/student/" + row.id)}
                aria-label={`View details of student ${row.name}`}
            >
                View
            </BlueButton>
            <PurpleButton
                ...
                aria-label={`View attendance of student ${row.name}`}
            >
                Attendance
            </PurpleButton>
        </>
    ...
    const ClassTeachersSection = () => (
        <>
            ...
            {/* Implement teacher management functionality here */}
        </>
    );
